...
if __name__ == '__main__':
    # Merge(0, 19, "White_Merged_Extended")
    # print("Datasets Merged")
    df_white = pd.read_csv("./Datasets_Generated/Merged_Datasets/White_Merged_Extended.csv")
    ...
    df.to_csv('./Datasets_Generated/Merged_Datasets/Final_Merged_Extended.csv', index=False, header=True)