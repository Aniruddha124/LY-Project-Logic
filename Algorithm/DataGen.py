...
def Generator(addresses, filename):
    ...
    for address in addresses:
        ...
        unique_in_degree = 0 #len(set(address_data['data']['bitcoin']['inbound']))
        unique_out_degree = 0 #len(set(address_data['data']['bitcoin']['outbound']))
...
addresses = ["bc1qwukmzzjqn5hwsp4uaswc4c53gc0xz5asrv0prx"]

Generator(addresses,"test")